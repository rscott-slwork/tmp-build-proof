...
if %edbgCnt% GTR 1 (
	...
	echo		edbg 
	echo		ATSAMR21G18A 
	echo		Tools\serial_bridge\samr21_xplained_pro_serial_bridge.elf 
...
echo  download_all_sb.bat edbg ATSAMR21G18A Tools\serial_bridge\samr21_xplained_pro_serial_bridge.elf %CHPFAM% %SN% 0
call download_all_sb.bat edbg ATSAMR21G18A Tools\serial_bridge\samr21_xplained_pro_serial_bridge.elf %CHPFAM% %SN% 0
