...
if %edbgCnt% GTR 1 (
	...
	echo		edbg 
	echo		ATSAMG53N19 
	echo		Tools\serial_bridge\samg53_xplained_pro_serial_bridge.elf 
...
echo  download_all_sb.bat edbg ATSAMG53N19 Tools\serial_bridge\samg53_xplained_pro_serial_bridge.elf %CHPFAM% %SN% 0
call download_all_sb.bat edbg ATSAMG53N19 Tools\serial_bridge\samg53_xplained_pro_serial_bridge.elf %CHPFAM% %SN% 0
