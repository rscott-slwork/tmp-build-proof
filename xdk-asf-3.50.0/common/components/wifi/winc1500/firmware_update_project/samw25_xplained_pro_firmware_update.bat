...
if %edbgCnt% GTR 1 (
	...
	echo		edbg 
	echo		ATSAMD21G18A 
	echo		Tools\serial_bridge\samw25_xplained_pro_serial_bridge.elf 
...
echo  download_all_sb.bat edbg ATSAMD21G18A Tools\serial_bridge\samw25_xplained_pro_serial_bridge.elf %CHPFAM% %SN% 0
call download_all_sb.bat edbg ATSAMD21G18A Tools\serial_bridge\samw25_xplained_pro_serial_bridge.elf %CHPFAM% %SN% 0
