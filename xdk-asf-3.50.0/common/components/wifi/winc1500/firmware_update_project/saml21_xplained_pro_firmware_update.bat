...
if %edbgCnt% GTR 1 (
	...
	echo		edbg 
	echo		ATSAML21J18B 
	echo		Tools\serial_bridge\saml21_xplained_pro_serial_bridge.elf 
...
echo  download_all_sb.bat edbg ATSAML21J18B Tools\serial_bridge\saml21_xplained_pro_serial_bridge.elf %CHPFAM% %SN% 0
call download_all_sb.bat edbg ATSAML21J18B Tools\serial_bridge\saml21_xplained_pro_serial_bridge.elf %CHPFAM% %SN% 0
